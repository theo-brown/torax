...
.. code-block:: python
  ...
  # Opens the in-memory data_tree returned by run_simulation in the
  # browser dashboard.
  torax.plot_run_from_data_tree({"TORAX": data_tree})
...
.. code-block:: python
  ...
  torax.plot_run({"TORAX": PATH_TO_LOCAL_NC_FILE})
