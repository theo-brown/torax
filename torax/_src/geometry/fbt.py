...
def _from_fbt(
  ...
  # TODO(theo-brown): extend to TrappedFractionSource.FILE (and update
  # _supported_trapped_fraction_sources) once the MEQ team provides trapped
  # fraction values in the LY files.
