...
class FixedPedestalConfig(pedestal_pydantic_model.BasePedestal):
  ...
  def build_runtime_params(
    ...
    return pedestal_runtime_params_lib.RuntimeParams(
        ...
        chi_H_mode_max=self.chi_H_mode_max,  # pyrefly: ignore[bad-argument-type]
        D_e_H_mode_max=self.D_e_H_mode_max,  # pyrefly: ignore[bad-argument-type]
        chi_H_mode_min=self.chi_H_mode_min,  # pyrefly: ignore[bad-argument-type]
        D_e_H_mode_min=self.D_e_H_mode_min,  # pyrefly: ignore[bad-argument-type]
