...
# TODO(b/434175938): Rename to fixed_point_method.
@jax.jit(
    static_argnames=[
        'coeffs_callback',
    ],
...
def predictor_corrector_method(
  ...
  if solver_params.use_predictor_corrector:
    x_new = jax_fixed_point.fixed_point(
        ...
        acceleration=solver_params.fixed_point_acceleration,
        anderson_depth=solver_params.anderson_depth,
        anderson_beta=solver_params.anderson_beta,
    )
  else:
